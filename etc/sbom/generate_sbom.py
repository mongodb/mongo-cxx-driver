...
def main() -> None:
    ...
    # Project scan or if using 'master/main' branch
    elif target == 'project' or git_info.branch in ['main','master']:
        version = git_info.branch
        purl_version = git_info.branch
        cpe_version = '*'
        logger.info(f"PRIMARY COMPONENT VERSION: Using branch '{git_info.branch}' as primary component version")
