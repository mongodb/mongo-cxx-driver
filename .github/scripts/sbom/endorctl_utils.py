...
class EndorCtl:
    ...
    def get_sbom(self, git_url: str, target: str = "project", ref: str = "default") -> dict:
        """Export latest SBOM for reference"""
        ...
        try:
            ...
            package_version_uuids = [
                package_version["uuid"] for package_version in package_versions if package_version
            ]
            package_version_names = [
                package_version["meta"]["name"] for package_version in package_versions if package_version
            ]
