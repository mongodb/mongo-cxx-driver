...
int main(int, char**) {
    ...
    // bsoncxx::builder::basic presents a BSON-construction interface familiar to users of the server's
    ...
    doc.append(kvp("foo", "bar")); // string literal value will be converted to b_utf8 automatically
    ...
    // If we want to create a subdocument, we can pass lambda as a value with a sub_document argument.
    ...
    doc.append(
         kvp("subdocument key", [](sub_document subdoc) {
