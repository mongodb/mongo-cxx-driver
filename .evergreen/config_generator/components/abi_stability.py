...
class AbiComplianceCheck(Function):
    ...
    commands = [
        ...
        s3_put(
            ...
            display_name='ABI Compliance Check (Stable) Logs: ',
            local_files_include_filter=['cxx-abi/*.log', 'cxx-abi/**/*.log', 'cxx-abi/**/log.txt'],
            permissions='public-read',
            remote_file='mongo-cxx-driver/${branch_name}/${revision}/${version_id}/${build_id}/${task_id}/${execution}/abi-compliance-check/abi/',
        ),
        s3_put(
        ...
        s3_put(
            ...
            bucket='mciuploads',
            content_type='text/plain',
            display_name='ABI Compliance Check (Unstable) Logs: ',
            local_files_include_filter=['cxx-noabi/*.log', 'cxx-noabi/**/*.log', 'cxx-noabi/**/log.txt'],
            permissions='public-read',
            remote_file='mongo-cxx-driver/${branch_name}/${revision}/${version_id}/${build_id}/${task_id}/${execution}/abi-compliance-check/noabi/',
        ),
    ]
