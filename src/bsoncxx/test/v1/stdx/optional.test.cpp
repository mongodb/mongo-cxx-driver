...
BSONCXX_PRIVATE_WARNINGS_DISABLE_FOR_GNU("-Wunused");
BSONCXX_PRIVATE_WARNINGS_DISABLE_FOR_Clang("-Wunused-member-function");
BSONCXX_PRIVATE_WARNINGS_DISABLE_FOR_Clang("-Wunneeded-member-function");
