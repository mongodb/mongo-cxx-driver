...
void find::read_preference(base::read_preference rp) { _read_preference = std::move(rp); }
...
const optional<base::read_preference>& find::read_preference() const { return _read_preference; }
