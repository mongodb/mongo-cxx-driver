...
MONGOCXX_PRIVATE_MOCKED_EXPORT(client_pool_set_structured_log_opts);
...
MONGOCXX_PRIVATE_MOCKED_EXPORT(client_set_structured_log_opts);
...
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_entry_get_component);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_entry_get_level);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_entry_get_message_string);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_entry_message_as_bson);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_get_component_name);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_get_level_name);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_get_named_component);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_get_named_level);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_opts_destroy);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_opts_get_max_document_length);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_opts_get_max_level_for_component);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_opts_new);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_opts_set_handler);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_opts_set_max_document_length);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_opts_set_max_document_length_from_env);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_opts_set_max_level_for_all_components);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_opts_set_max_level_for_component);
MONGOCXX_PRIVATE_MOCKED_EXPORT(structured_log_opts_set_max_levels_from_env);
