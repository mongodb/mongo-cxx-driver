...
class transaction::impl {
   public:
    ...
    bsoncxx::stdx::optional<mongocxx::v_noabi::read_concern> read_concern() const {
        ...
        return bsoncxx::stdx::optional<mongocxx::v_noabi::read_concern>(std::move(rci));
    }
    ...
    bsoncxx::stdx::optional<mongocxx::v_noabi::write_concern> write_concern() const {
        ...
        return bsoncxx::stdx::optional<mongocxx::v_noabi::write_concern>(std::move(wci));
    }
    ...
    bsoncxx::stdx::optional<mongocxx::v_noabi::read_preference> read_preference() const {
        ...
        return bsoncxx::stdx::optional<mongocxx::v_noabi::read_preference>(std::move(rpi));
    }
    ...
    bsoncxx::stdx::optional<std::chrono::milliseconds> max_commit_time_ms() const {
