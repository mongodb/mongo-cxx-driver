...
const bsoncxx::stdx::optional<bool>& find::allow_disk_use() const {
...
const bsoncxx::stdx::optional<bsoncxx::v_noabi::document::view_or_value>& find::collation() const {
    return _collation;
}

const bsoncxx::stdx::optional<bsoncxx::v_noabi::string::view_or_value>& find::comment() const {
    return _comment;
}

const bsoncxx::stdx::optional<cursor::type>& find::cursor_type() const {
    return _cursor_type;
}

const bsoncxx::stdx::optional<mongocxx::v_noabi::hint>& find::hint() const {
    return _hint;
}

const bsoncxx::stdx::optional<std::int64_t>& find::limit() const {
    return _limit;
}

const bsoncxx::stdx::optional<bsoncxx::v_noabi::document::view_or_value> find::let() const {
    return _let;
}
...
const bsoncxx::stdx::optional<bsoncxx::v_noabi::document::view_or_value>& find::max() const {
    return _max;
}

const bsoncxx::stdx::optional<std::chrono::milliseconds>& find::max_await_time() const {
    return _max_await_time;
}

const bsoncxx::stdx::optional<std::chrono::milliseconds>& find::max_time() const {
    return _max_time;
}

const bsoncxx::stdx::optional<bsoncxx::v_noabi::document::view_or_value>& find::min() const {
    return _min;
}
...
const bsoncxx::stdx::optional<bsoncxx::v_noabi::document::view_or_value>& find::projection() const {
    return _projection;
}

const bsoncxx::stdx::optional<bool>& find::return_key() const {
    return _return_key;
}

const bsoncxx::stdx::optional<bool>& find::show_record_id() const {
    return _show_record_id;
}

const bsoncxx::stdx::optional<std::int64_t>& find::skip() const {
    return _skip;
}

const bsoncxx::stdx::optional<bsoncxx::v_noabi::document::view_or_value>& find::sort() const {
    return _ordering;
}

const bsoncxx::stdx::optional<mongocxx::v_noabi::read_preference>& find::read_preference() const {
