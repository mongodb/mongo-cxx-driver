...
const bsoncxx::v_noabi::stdx::optional<bsoncxx::v_noabi::document::view_or_value> replace::let() const {
    return _let;
}

const bsoncxx::v_noabi::stdx::optional<bsoncxx::v_noabi::types::bson_value::view_or_value> replace::comment() const {
    return _comment;
}
...
const bsoncxx::v_noabi::stdx::optional<bsoncxx::v_noabi::document::view_or_value>& replace::collation() const {
    return _collation;
}
...
const bsoncxx::v_noabi::stdx::optional<mongocxx::v_noabi::write_concern>& replace::write_concern() const {
