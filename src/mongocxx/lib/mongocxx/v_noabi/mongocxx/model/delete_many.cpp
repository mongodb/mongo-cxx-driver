...
const bsoncxx::stdx::optional<mongocxx::v_noabi::hint>& delete_many::hint() const {
    return _hint;
}

const bsoncxx::stdx::optional<bsoncxx::v_noabi::document::view_or_value>& delete_many::collation()
    const {
    return _collation;
}
