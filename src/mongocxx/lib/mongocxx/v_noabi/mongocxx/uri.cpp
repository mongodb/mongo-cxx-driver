...
mongocxx::v_noabi::read_concern uri::read_concern() const {
    ...
    return mongocxx::v_noabi::read_concern(
        bsoncxx::stdx::make_unique<read_concern::impl>(libmongoc::read_concern_copy(rc)));
}
...
mongocxx::v_noabi::read_preference uri::read_preference() const {
    ...
    return mongocxx::v_noabi::read_preference(
        bsoncxx::stdx::make_unique<read_preference::impl>(libmongoc::read_prefs_copy(rp)));
}
...
mongocxx::v_noabi::write_concern uri::write_concern() const {
    ...
    return mongocxx::v_noabi::write_concern(
        bsoncxx::stdx::make_unique<write_concern::impl>(libmongoc::write_concern_copy(wc)));
}

static bsoncxx::stdx::optional<bsoncxx::stdx::string_view> _string_option(mongoc_uri_t* uri,
                                                                          std::string opt_name) {
    const char* value;
    ...
    return bsoncxx::stdx::string_view{value};
}

static bsoncxx::stdx::optional<std::int32_t> _int32_option(mongoc_uri_t* uri,
                                                           std::string opt_name) {
    bson_iter_t iter;
...
static bsoncxx::stdx::optional<bool> _bool_option(mongoc_uri_t* uri, std::string opt_name) {
    bson_iter_t iter;
    const bson_t* options_bson = libmongoc::uri_get_options(uri);
...
bsoncxx::stdx::optional<bsoncxx::v_noabi::document::view> uri::credentials() {
...
bsoncxx::stdx::optional<std::int32_t> uri::srv_max_hosts() const {
    return _int32_option(_impl->uri_t, MONGOC_URI_SRVMAXHOSTS);
}

static bsoncxx::stdx::optional<bsoncxx::v_noabi::document::view> _credential_document_option(
...
bsoncxx::stdx::optional<bsoncxx::stdx::string_view> uri::appname() const {
...
bsoncxx::stdx::optional<bsoncxx::v_noabi::document::view> uri::auth_mechanism_properties() const {
    return _credential_document_option(_impl->uri_t, "authMechanismProperties");
}

std::vector<bsoncxx::stdx::string_view> uri::compressors() const {
    const bson_t* compressors;
    std::vector<bsoncxx::stdx::string_view> result;
    bson_iter_t iter;
    ...
    while (bson_iter_next(&iter)) {
        result.push_back(
            bsoncxx::stdx::string_view{bson_iter_key(&iter), bson_iter_key_len(&iter)});
    }
    return result;
}

bsoncxx::stdx::optional<std::int32_t> uri::connect_timeout_ms() const {
    return _int32_option(_impl->uri_t, "connectTimeoutMS");
}

bsoncxx::stdx::optional<bool> uri::direct_connection() const {
    return _bool_option(_impl->uri_t, "directConnection");
}

bsoncxx::stdx::optional<std::int32_t> uri::heartbeat_frequency_ms() const {
    return _int32_option(_impl->uri_t, "heartbeatFrequencyMS");
}

bsoncxx::stdx::optional<std::int32_t> uri::local_threshold_ms() const {
    return _int32_option(_impl->uri_t, "localThresholdMS");
}

bsoncxx::stdx::optional<std::int32_t> uri::max_pool_size() const {
    return _int32_option(_impl->uri_t, "maxPoolSize");
}

bsoncxx::stdx::optional<bool> uri::retry_reads() const {
    return _bool_option(_impl->uri_t, "retryReads");
}

bsoncxx::stdx::optional<bool> uri::retry_writes() const {
    return _bool_option(_impl->uri_t, "retryWrites");
}

bsoncxx::stdx::optional<std::int32_t> uri::server_selection_timeout_ms() const {
    return _int32_option(_impl->uri_t, "serverSelectionTimeoutMS");
}

bsoncxx::stdx::optional<bool> uri::server_selection_try_once() const {
    return _bool_option(_impl->uri_t, "serverSelectionTryOnce");
}

bsoncxx::stdx::optional<std::int32_t> uri::socket_timeout_ms() const {
    return _int32_option(_impl->uri_t, "socketTimeoutMS");
}

bsoncxx::stdx::optional<bool> uri::tls_allow_invalid_certificates() const {
    return _bool_option(_impl->uri_t, "tlsAllowInvalidCertificates");
}

bsoncxx::stdx::optional<bool> uri::tls_allow_invalid_hostnames() const {
    return _bool_option(_impl->uri_t, "tlsAllowInvalidHostnames");
}

bsoncxx::stdx::optional<bsoncxx::stdx::string_view> uri::tls_ca_file() const {
    return _string_option(_impl->uri_t, "tlsCAFile");
}

bsoncxx::stdx::optional<bsoncxx::stdx::string_view> uri::tls_certificate_key_file() const {
    return _string_option(_impl->uri_t, "tlsCertificateKeyFile");
}

bsoncxx::stdx::optional<bsoncxx::stdx::string_view> uri::tls_certificate_key_file_password() const {
    return _string_option(_impl->uri_t, "tlsCertificateKeyFilePassword");
}

bsoncxx::stdx::optional<bool> uri::tls_disable_certificate_revocation_check() const {
    return _bool_option(_impl->uri_t, "tlsDisableCertificateRevocationCheck");
}

bsoncxx::stdx::optional<bool> uri::tls_disable_ocsp_endpoint_check() const {
    return _bool_option(_impl->uri_t, "tlsDisableOCSPEndpointCheck");
}

bsoncxx::stdx::optional<bool> uri::tls_insecure() const {
    return _bool_option(_impl->uri_t, "tlsInsecure");
}

bsoncxx::stdx::optional<std::int32_t> uri::wait_queue_timeout_ms() const {
    return _int32_option(_impl->uri_t, "waitQueueTimeoutMS");
}

bsoncxx::stdx::optional<std::int32_t> uri::zlib_compression_level() const {
