...
class tls {
   ...
   private:
    bsoncxx::stdx::optional<bsoncxx::v_noabi::string::view_or_value> _pem_file;
    bsoncxx::stdx::optional<bsoncxx::v_noabi::string::view_or_value> _pem_password;
    bsoncxx::stdx::optional<bsoncxx::v_noabi::string::view_or_value> _ca_file;
    bsoncxx::stdx::optional<bsoncxx::v_noabi::string::view_or_value> _ca_dir;
    bsoncxx::stdx::optional<bsoncxx::v_noabi::string::view_or_value> _crl_file;
