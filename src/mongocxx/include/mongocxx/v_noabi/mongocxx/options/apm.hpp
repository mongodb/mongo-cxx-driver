...
class apm {
   public:
    ...
    on_command_started(std::function<void MONGOCXX_ABI_CDECL(const events::command_started_event&)> command_started);
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(const std::function<void MONGOCXX_ABI_CDECL(const events::command_started_event&)>&)
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(apm&)
    on_command_failed(std::function<void MONGOCXX_ABI_CDECL(const events::command_failed_event&)> command_failed);
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(const std::function<void MONGOCXX_ABI_CDECL(const events::command_failed_event&)>&)
    ...
    on_command_succeeded(
        std::function<void MONGOCXX_ABI_CDECL(const events::command_succeeded_event&)> command_succeeded);
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(const std::function<void MONGOCXX_ABI_CDECL(const events::command_succeeded_event&)>&)
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(apm&)
    on_server_opening(std::function<void MONGOCXX_ABI_CDECL(const events::server_opening_event&)> server_opening);
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(const std::function<void MONGOCXX_ABI_CDECL(const events::server_opening_event&)>&)
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(apm&)
    on_server_closed(std::function<void MONGOCXX_ABI_CDECL(const events::server_closed_event&)> server_closed);
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(const std::function<void MONGOCXX_ABI_CDECL(const events::server_closed_event&)>&)
    server_closed() const;
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(apm&)
    on_server_changed(std::function<void MONGOCXX_ABI_CDECL(const events::server_changed_event&)> server_changed);
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(const std::function<void MONGOCXX_ABI_CDECL(const events::server_changed_event&)>&)
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(apm&)
    on_topology_opening(std::function<void MONGOCXX_ABI_CDECL(const events::topology_opening_event&)> topology_opening);
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(const std::function<void MONGOCXX_ABI_CDECL(const events::topology_opening_event&)>&)
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(apm&)
    on_topology_closed(std::function<void MONGOCXX_ABI_CDECL(const events::topology_closed_event&)> topology_closed);
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(const std::function<void MONGOCXX_ABI_CDECL(const events::topology_closed_event&)>&)
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(apm&)
    on_topology_changed(std::function<void MONGOCXX_ABI_CDECL(const events::topology_changed_event&)> topology_changed);
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(const std::function<void MONGOCXX_ABI_CDECL(const events::topology_changed_event&)>&)
    ...
    on_heartbeat_started(
        std::function<void MONGOCXX_ABI_CDECL(const events::heartbeat_started_event&)> heartbeat_started);
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(const std::function<void MONGOCXX_ABI_CDECL(const events::heartbeat_started_event&)>&)
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(apm&)
    on_heartbeat_failed(std::function<void MONGOCXX_ABI_CDECL(const events::heartbeat_failed_event&)> heartbeat_failed);
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(const std::function<void MONGOCXX_ABI_CDECL(const events::heartbeat_failed_event&)>&)
    ...
    on_heartbeat_succeeded(
        std::function<void MONGOCXX_ABI_CDECL(const events::heartbeat_succeeded_event&)> heartbeat_succeeded);
    ...
    ///
    MONGOCXX_ABI_EXPORT_CDECL(const std::function<void MONGOCXX_ABI_CDECL(const events::heartbeat_succeeded_event&)>&)
   ...
   private:
    ...
    std::function<void MONGOCXX_ABI_CDECL(const events::command_succeeded_event&)> _command_succeeded;
    ...
    std::function<void MONGOCXX_ABI_CDECL(const events::heartbeat_started_event&)> _heartbeat_started;
    std::function<void MONGOCXX_ABI_CDECL(const events::heartbeat_failed_event&)> _heartbeat_failed;
    std::function<void MONGOCXX_ABI_CDECL(const events::heartbeat_succeeded_event&)> _heartbeat_succeeded;
};
