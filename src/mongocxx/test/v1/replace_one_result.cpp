...
TEST_CASE("ownership", "[mongocxx][v1][replace_one_result]") {
    ...
    replace_one_result source = v1::replace_one_result::internal::make(source_value);
    replace_one_result target = v1::replace_one_result::internal::make(target_value);
...
TEST_CASE("basic", "[mongocxx][v1][replace_one_result]") {
...
TEST_CASE("equality", "[mongocxx][v1][replace_one_result]") {
    ...
    auto lhs = v1::replace_one_result::internal::make(n0);
    auto rhs = v1::replace_one_result::internal::make(n0);
    ...
    SECTION("result") {
        v1::replace_one_result::internal::result(rhs) = n1;
