...
TEST_CASE("ownership", "[mongocxx][v1][insert_one_options]") {
    insert_one_options source;
    insert_one_options target;
...
TEST_CASE("default", "[mongocxx][v1][insert_one_options]") {
...
TEST_CASE("bypass_document_validation", "[mongocxx][v1][insert_one_options]") {
...
TEST_CASE("write_concern", "[mongocxx][v1][insert_one_options]") {
    ...
    CHECK(insert_one_options{}.write_concern(v).write_concern() == v);
}

TEST_CASE("comment", "[mongocxx][v1][insert_one_options]") {
    ...
    CHECK(insert_one_options{}.comment(v).comment() == v);
}
