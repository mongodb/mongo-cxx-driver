...
TEST_CASE("ownership", "[mongocxx][v1][delete_one_result]") {
    ...
    delete_one_result source = v1::delete_one_result::internal::make(source_value);
    delete_one_result target = v1::delete_one_result::internal::make(target_value);
...
TEST_CASE("basic", "[mongocxx][v1][delete_one_result]") {
    auto const deleted_count = GENERATE(0, 1);

    auto const res = v1::delete_one_result::internal::make(
...
TEST_CASE("equality", "[mongocxx][v1][delete_one_result]") {
    ...
    auto lhs = v1::delete_one_result::internal::make(n0);
    auto rhs = v1::delete_one_result::internal::make(n0);
    ...
    SECTION("result") {
        v1::delete_one_result::internal::result(rhs) = n1;
