...
enum class error_code : std::int32_t {
    // Begin mongoc errors. See mongoc.org/libmongoc/current/errors.html.
    k_stream_invalid_type = 1,
    ...
    k_collection_does_not_exist = 26,
    ...
    k_query_command_not_found = 59,

    k_query_not_tailable = 13051,
    ...
    k_gridfs_chunk_missing,

    k_gridfs_protocol_error,

    /* dup with query failure. */

    k_protocol_error = 17,

    k_write_concern_error = 64,
