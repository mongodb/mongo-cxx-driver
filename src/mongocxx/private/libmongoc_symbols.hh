...
MONGOCXX_LIBMONGOC_SYMBOL(bulk_operation_remove_with_opts)
...
MONGOCXX_LIBMONGOC_SYMBOL(bulk_operation_update_with_opts)
...
MONGOCXX_LIBMONGOC_SYMBOL(read_prefs_get_max_staleness_ms)
...
MONGOCXX_LIBMONGOC_SYMBOL(read_prefs_set_max_staleness_ms)
